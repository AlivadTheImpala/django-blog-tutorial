...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('first_names', models.CharField(help_text='The contributors first name or names.', max_length=50)),
                ('last_names', models.CharField(help_text='The contributors last name or names', max_length=50)),
                ('email', models.EmailField(help_text='The contributors contact email', max_length=254)),
            ],
        ),
        migrations.CreateModel(
            name='Review',
